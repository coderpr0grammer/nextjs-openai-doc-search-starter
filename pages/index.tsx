  ...
  return (
    ...
    >
      ...
      <main className={styles.main} onDrop={handleDrop} onDragOver={(event) => event.preventDefault()}>
        ...
        {/* File upload overlay */}
      {isDragging && (
        <div className={styles.overlay} style={{background: 'rgba(255, 0, 0, 0.8)', width: 100, height:100, margin: 0, padding: 0, display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'absolute', }}>
